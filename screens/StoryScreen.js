      ...
      return (
        ...
        >
          ...
          <View style={styles.storyContainer}>
            ...
            >
              <Image
                source={require("../assets/Books/book1Img.jpg")}
                style={styles.image}
              ></Image>
              ...
              <View style={styles.storyTextContainer}>
               ...
               <TouchableOpacity 
               style={{ backgroundColor:"pink" , width:200,height:20}}
               onPress={()=>Linking.openURL(this.props.route.params.story.source).catch(err=>console.error("could not load page",err))}
              ...
              <Text
                ...
                >
                  link of the story - {this.props.route.params.story.source}
                </Text>
         </TouchableOpacity>
